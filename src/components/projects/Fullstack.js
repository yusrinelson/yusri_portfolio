      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:px-4 pb-4">
        {fullstack.map(({ id, src, site, github, title, description }) => (
          ...
          >
              ...
              <div className="w-[90%] h-full text-center">
                {!failedVideos[id] ? (
                  <video
                    ...
                    onMouseEnter={handleMouseEnter}
                    onMouseLeave={handleMouseLeave}
                    onError={() => handleVideoError(id)} // catch video load errors
                  ...
                  <img
                    src={src}
                    alt={title}
                    className="duration-200 w-full h-[139px] hover:scale-105"
                  />
                )}
              </div>
            ...
            <div className="w-full h-[20%] text-center flex items-center justify-center font-extrabold pb-4J">
              {title}
            </div>
          </div>
        ))}
