export const layout = {
    sectionGtoB: `w-full bg-gradient-to-b from-gray-800 to-black pb-20`,
    sectionBtoG: `w-full bg-gradient-to-b from-black to-gray-800 pb-20`,
    buttongradient:`my-2 flex w-fit cursor-pointer items-center rounded-md bg-gradient-to-r from-blue-500 to-cyan-500 px-2 sm:px-2 md:px-2 py-3 text-white font-bold`,
