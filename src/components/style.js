export const layout = {
    ...
    buttongradient:`my-2 flex w-fit cursor-pointer items-center rounded-md bg-gradient-to-r from-blue-500 to-cyan-500 px-2 sm:px-6 py-3 text-white font-bold`,
