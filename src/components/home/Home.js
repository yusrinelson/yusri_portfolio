...
export default function Home() {
  return (
        <div className="box__color w-full h-[97vh] rounded-md flex flex-col justify-center">
            <div className="ml-[20%] h-full flex flex-col justify-center">
                ...
                <h1 className="text-4xl mb-3 bg-gradient-to-r from-[#44BD03] via-[#00FFF2] to-[#00FFF2] bg-clip-text text-transparent">Fullstack Developer</h1>
